...
import 'package:project/pages/wallet/wallet.dart';
              ...
              : () {
                  if (model.transactionSuccess) {
                    Timer(Duration(seconds: 3), () {
                      Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (BuildContext context) =>
                              WalletPage(model, model.offeringPayable)));
                    });
                    model.addTransaction(Transaction(
                        ...
                        clientDetails: model.client == null
                            ? null
                            : ClientDetails(
                                clientId: model.client.id,
                                clientName: model.client.name),
                        vendorDetails: model.vendor == null
                            ? null
                            : VendorDetails(
                  ...
                  return Center(
                    child: Column(
                      ...
                      children: <Widget>[
                        ...
                        HeadlineText(
                          text:
                              "${_verificationMessage ?? "Verification Unsuccessful"}",
