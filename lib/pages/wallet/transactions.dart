...
class _TransactionsPageState extends State<TransactionsPage> {
  final List<Transaction> transactions = [
    Transaction(
        ...
        clientDetails: ClientDetails(clientId: '22sks', clientName: 'Ashish'),
        vendorDetails:
            VendorDetails(vendorId: "sjsns", vendorName: "Anuradha")),
    Transaction(
        pending: false,
        type: 'Household Waste',
        amount: 3000,
      ...
      body: ScopedModelDescendant<MainModel>(
        builder: (BuildContext context, Widget child, MainModel model) {
          return
              ...
              //       )
              //     : (model.transactions != null && model.transactions.length > 0)
              //?
              Container(
