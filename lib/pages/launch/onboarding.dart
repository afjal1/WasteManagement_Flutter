...
import 'package:project/utils/responsive.dart';
  ...
  List<Map<String, String>> _infoList = [
    {
      ...
      'title': 'How Waste Master works',
      'body': "Let's quickly review how you can use Waste Master",
    },
    {
      ...
      child: AnimatedBuilder(
        ...
        builder: (BuildContext context, Widget child) {
          return Container(
            height: 5,
            color: Colors.white
                .withOpacity(_getOpacity(_controllers[pos - 1].value)),
