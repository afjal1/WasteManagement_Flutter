  ...
  Widget _buildCategoryWidget(
    ...
    return OutlineButton(
      ...
      padding: EdgeInsets.symmetric(
          horizontal: getSize(context, 30), vertical: getSize(context, 30)),
      child: Column(
        children: <Widget>[
          Image(
            ...
            child: RichText(
              ...
              text: TextSpan(
                  ...
                  children: [
                    ...
                    TextSpan(text: title == "Info" ? "Center" : "Waste")
                  ]),
            ),
          )
        ],
        ...
        children: <Widget>[
          Row(
            ...
            children: <Widget>[
              ...
              _buildCategoryWidget(context, 'Recycle', 'assets/eco-factory.png',
                  RecycleWastePage())
            ],
          ),
          SizedBox(
          ...
          Row(
            ...
            children: <Widget>[
              ...
              _buildCategoryWidget(context, 'Info', 'assets/analysis.png')
